...
In order to fill checkboxes and other multiselect items you need to follow these guidelines. Example checkbox input:
...
Notice the id's contain the value of the element in brackets letter for letter (same case).
