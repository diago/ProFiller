...
Form Filler is straight forward. Instaniate the class with the id of the form and use the fill method to populate.
...
|_. Calback |_. Description |
| onStart | triggered when FormFiller#fill is called |
| onComplete | triggered after the form has been filled |
...
| FormFiller#reset | Resets the form to the forms original values (values taken when FormFiller was instaniated) |